                ...
                <div className="flex flex-wrap justify-center items-center gap-2 mb-12">
                    {CATEGORIES.map((tab) => (
                        <button
                            ...
                            className={`px-6 py-2.5 font-['raleway'] text-[13px] font-semibold tracking-[0.15em] uppercase border transition-all duration-300 cursor-pointer ${selectedCategory === tab.id
